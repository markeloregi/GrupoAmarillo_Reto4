...
#CON MUESTREO
set.seed(14);filas<-sample(1:22490,5000)
set.seed(14);columnas<-sample(1:1759,500)

datos_muestra<-datos[filas,columnas]

datos_muestra<-as(datos_muestra,"matrix")
...
resultados_datos_no_mod<-rbind(eval_accuracy_ibcf_NL_muestra,eval_accuracy_ubcf_NL_muestra,eval_accuracy_random_NL_muestra,eval_accuracy_popular_NL_muestra,eval_accuracy_SVD_NL_muestra)

resultados_error_no_mod<-rbind(eval_accuracy_ibcf_muestra,eval_accuracy_ubcf_muestra,eval_accuracy_random_muestra,eval_accuracy_popular_muestra,eval_accuracy_SVD_muestra)
...
resultados_datos_norm<-rbind(eval_accuracy_ibcf_NL_muestra_norm,eval_accuracy_ubcf_NL_muestra_norm,eval_accuracy_random_NL_muestra_norm,eval_accuracy_popular_NL_muestra_norm,eval_accuracy_SVD_NL_muestra_norm)

resultados_error_norm<-rbind(eval_accuracy_ibcf_muestra_norm,eval_accuracy_ubcf_muestra_norm,eval_accuracy_random_muestra_norm,eval_accuracy_popular_muestra_norm,eval_accuracy_SVD_muestra_norm)
...
datos_rrm_muestra_binarizados<-binarize(datos_rrm_muestra,minRating=1)

#partición de datos
set.seed(7);eval_schem_muestra_bin<-evaluationScheme(datos_rrm_muestra_binarizados,method="split",train=0.8,given=1,goodRating=1)

#ibcf
eval_recommender_ibcf_bin<-Recommender(getData(eval_schem_muestra_bin,"train"),"IBCF",param=list(method="Pearson"))

eval_prediction_ibcf_NL_bin<-predict(object=eval_recommender_ibcf_bin,newdata=getData(eval_schem_muestra_bin,"known"),type="topNList",n=10)

eval_accuracy_ibcf_NL_bin<-calcPredictionAccuracy(eval_prediction_ibcf_NL_bin,getData(eval_schem_muestra_bin,"unknow"),goodRating=2,given=10)

# UBCF
eval_recommender_ubcf_bin <- Recommender(getData(eval_schem_muestra_bin, "train"), "UBCF", param = list(method = "Pearson"))

eval_prediction_ubcf_NL_bin <- predict(object = eval_recommender_ubcf_bin,newdata = getData(eval_schem_muestra_bin, "known"),type = "topNList",n = 10)

eval_accuracy_ubcf_NL_bin <- calcPredictionAccuracy(eval_prediction_ubcf_NL_bin,getData(eval_schem_muestra_bin, "unknow"),goodRating = 2, given = 10)

#random
eval_recommender_random_bin<-Recommender(getData(eval_schem_muestra_bin,"train"),"IBCF",param=list(method="Pearson"))

eval_prediction_random_NL_bin<-predict(object=eval_recommender_random_bin,newdata=getData(eval_schem_muestra_bin,"known"),type="topNList",n=10)

eval_accuracy_random_NL_bin<-calcPredictionAccuracy(eval_prediction_random_NL_bin,getData(eval_schem_muestra_bin,"unknow"),goodRating=2,given=10)

# popular
eval_recommender_popular_bin <- Recommender(getData(eval_schem_muestra_bin, "train"), "UBCF", param = list(method = "Pearson"))

eval_prediction_popular_NL_bin <- predict(object = eval_recommender_popular_bin,newdata = getData(eval_schem_muestra_bin, "known"),type = "topNList",n = 10)

eval_accuracy_popular_NL_bin <- calcPredictionAccuracy(eval_prediction_popular_NL_bin,getData(eval_schem_muestra_bin, "unknow"),goodRating = 2, given = 10)


resultados_datos_bin<-rbind(eval_accuracy_ibcf_NL_bin,eval_accuracy_ubcf_NL_bin,eval_accuracy_random_NL_bin,eval_accuracy_popular_NL_bin)
...
# 
# #ubcf
# eval_recommender_ubcf_norm<-Recommender(getData(eval_schem,"train"),"UBCF",param=list(method="Pearson"))
# 
# eval_prediction_ubcf_norm<-predict(object=eval_recommender_ubcf_norm,newdata=getData(eval_schem,"known"),type="ratings")
# 
# eval_accuracy_ubcf_norm<-calcPredictionAccuracy(eval_prediction_ubcf_norm,getData(eval_schem,"unknow"),given=10,goodRating=1)
# 
# eval_prediction_ubcf_NL_norm<-predict(object=eval_recommender_ubcf_norm,newdata=getData(eval_schem,"known"),type="topNList",n=10)
# 
# eval_accuracy_ubcf_NL_norm<-calcPredictionAccuracy(eval_prediction_ubcf_NL_norm,getData(eval_schem,"unknow"),goodRating=2,given=10)
# 
# #random
# eval_recommender_random_norm<-Recommender(getData(eval_schem,"train"),"IBCF",param=list(method="Pearson"))
# 
# eval_prediction_random_norm<-predict(object=eval_recommender_random_norm,newdata=getData(eval_schem,"known"),type="ratings")
# 
# eval_accuracy_random_norm<-calcPredictionAccuracy(eval_prediction_random_norm,getData(eval_schem,"unknow"),given=10,goodRating=1)
# 
# eval_prediction_random_NL_norm<-predict(object=eval_recommender_random_norm,newdata=getData(eval_schem,"known"),type="topNList",n=10)
# 
# eval_accuracy_random_NL_norm<-calcPredictionAccuracy(eval_prediction_random_NL_norm,getData(eval_schem,"unknow"),goodRating=2,given=10)
# 
# #popular
# eval_recommender_popular_norm<-Recommender(getData(eval_schem,"train"),"IBCF",param=list(method="Pearson"))
# 
# eval_prediction_popular_norm<-predict(object=eval_recommender_popular_norm,newdata=getData(eval_schem,"known"),type="ratings")
# 
# eval_accuracy_popular_norm<-calcPredictionAccuracy(eval_prediction_popular_norm,getData(eval_schem,"unknow"),given=10,goodRating=1)
# 
# eval_prediction_popular_NL_norm<-predict(object=eval_recommender_popular_norm,newdata=getData(eval_schem,"known"),type="topNList",n=10)
# 
# eval_accuracy_popular_NL_norm<-calcPredictionAccuracy(eval_prediction_popular_NL_norm,getData(eval_schem,"unknow"),goodRating=2,given=10)
# 
# 
# 
# # con datos binarizados ---------------------------------------------------
...
# 
# #random
# eval_recommender_random_bin<-Recommender(getData(eval_schem_bin,"train"),"IBCF",param=list(method="Pearson"))
# 
# eval_prediction_random_NL_bin<-predict(object=eval_recommender_random_bin,newdata=getData(eval_schem_bin,"known"),type="topNList",n=10)
# 
# eval_accuracy_random_NL_bin<-calcPredictionAccuracy(eval_prediction_random_NL_bin,getData(eval_schem_bin,"unknow"),goodRating=2,given=10)
# 
# # popular
# eval_recommender_popular_bin <- Recommender(getData(eval_schem_bin, "train"), "UBCF", param = list(method = "Pearson"))
# 
# eval_prediction_popular_NL_bin <- predict(object = eval_recommender_popular_bin,newdata = getData(eval_schem_bin, "known"),type = "topNList",n = 10)
# 
# eval_accuracy_popular_NL_bin <- calcPredictionAccuracy(eval_prediction_popular_NL_bin,getData(eval_schem_bin, "unknow"),goodRating = 2, given = 10)
